...
// Make changes to PostOffice.h instead.

#import <CoreData/CoreData.h>


extern const struct PostOfficeAttributes {
...
} PostOfficeAttributes;

extern const struct PostOfficeRelationships {
} PostOfficeRelationships;

extern const struct PostOfficeFetchedProperties {
} PostOfficeFetchedProperties;
...
@interface PostOfficeID : NSManagedObjectID {}
@end

@interface _PostOffice : NSManagedObject {}
...
@interface _PostOffice (CoreDataGeneratedAccessors)

@end

@interface _PostOffice (CoreDataGeneratedPrimitiveAccessors)
