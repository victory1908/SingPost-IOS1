...
// Make changes to PostingBox.h instead.

#import <CoreData/CoreData.h>


extern const struct PostingBoxAttributes {
...
} PostingBoxAttributes;

extern const struct PostingBoxRelationships {
} PostingBoxRelationships;

extern const struct PostingBoxFetchedProperties {
} PostingBoxFetchedProperties;
...
@interface PostingBoxID : NSManagedObjectID {}
@end

@interface _PostingBox : NSManagedObject {}
...
@interface _PostingBox (CoreDataGeneratedAccessors)

@end

@interface _PostingBox (CoreDataGeneratedPrimitiveAccessors)
