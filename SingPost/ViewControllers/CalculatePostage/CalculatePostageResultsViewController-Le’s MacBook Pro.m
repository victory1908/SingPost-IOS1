...
//    [resultsTableView setEstimatedRowHeight:200];
...
//                                                           attributes:@{NSFontAttributeName:[UIFont SingPostRegularFontOfSize:15.0f fontKey:kSingPostFontOpenSans]}
//                                                              context:nil];
//    CGRect statusRect = [item.deliveryTime boundingRectWithSize:CGSizeMake(190, 0)
//                                                              options:NSStringDrawingUsesLineFragmentOrigin
//                                                           attributes:@{NSFontAttributeName:[UIFont SingPostRegularFontOfSize:15.0f fontKey:kSingPostFontOpenSans]}
//                                                              context:nil];
//    
//    CGRect typeRect = [item.deliveryServiceType boundingRectWithSize:CGSizeMake(190, 0)
//                                                        options:NSStringDrawingUsesLineFragmentOrigin
//                                                     attributes:@{NSFontAttributeName:[UIFont SingPostRegularFontOfSize:15.0f fontKey:kSingPostFontOpenSans]}
//                                                        context:nil];

    
//    CGFloat labelHeight = labelRect.size.height + statusRect.size.height + typeRect.size.height;
