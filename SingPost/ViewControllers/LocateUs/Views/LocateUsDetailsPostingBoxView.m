...
- (id)initWithPostingBox:(EntityLocation *)postingBox andFrame:(CGRect)frame
{
    ...
    if ((self = [super initWithFrame:frame])) {
        ...
        [openingHoursHeaderLabel setText:@"Last Collection Time"];
        ...
        if (![self isWeekdayOpeningSame]) {
            ...
            [monOpeningHoursLabel setText:_postingBox.monOpeningHours];
            ...
            [tuesOpeningHoursLabel setText:_postingBox.tuesOpeningHours];
            ...
            [wedOpeningHoursLabel setText:_postingBox.wedOpeningHours];
            ...
            [thursOpeningHoursLabel setText:_postingBox.thursOpeningHours];
            ...
            [friOpeningHoursLabel setText:_postingBox.friOpeningHours];
            ...
            monToFriOpeningHoursLabel.text = _postingBox.monOpeningHours;
        ...
        //populate fields
        [saturdayOpeningHoursLabel setText:_postingBox.satOpeningHours];
        [sundayOpeningHoursLabel setText:_postingBox.sunOpeningHours];
        [publicHolidayOpeningHoursLabel setText:_postingBox.publicHolidayOpeningHours];
    }
...
- (BOOL)isWeekdayOpeningSame {
    ...
    NSArray *tempArray = [NSArray arrayWithObjects:_postingBox.tuesOpeningHours,_postingBox.wedOpeningHours,
                          _postingBox.thursOpeningHours,_postingBox.friOpeningHours, nil];
    
    for (NSString *openingHours in tempArray) {
        if (![openingHours isEqualToString:_postingBox.monOpeningHours])
            return NO;
    }
    return YES;
}
